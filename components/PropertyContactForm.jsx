...
const PropertyContanctForm = ({property}) => {
  ...
  useEffect(() => {
    ...
    if(state.submitted) toast.success('Message sent succesfully');
  } ,[state])

  // submitted comes from addMessage
  if(state.submitted) {
    return (
...
export default PropertyContanctForm;